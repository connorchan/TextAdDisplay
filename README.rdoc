...
AdShow is a web app (in development) for previewing digital ad campaign set-ups to clients. This software is meant to be used by PPC agencies and digital marketers to help clients visualize what their ads are going to look like on various platforms when launched.
...
== Database
AdShow uses PostgreSQL to store user info (via Devise) and file uploads.
